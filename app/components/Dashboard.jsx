...
//           flushBuffer();
//           console.log("Final data.l2Data:", data.l2Data);
//           setIsLoading(false);
...
//     if (!selectedTransactionId) return { l2Data: [], metricsData: [], errors: [] }; // Show nothing until ID is selected
//     return {
...
//           {selectedTransactionId ? <SystemMetrics l2Data={filteredData.l2Data} /> : <div className="text-center text-gray-500 p-4">Please select a Transaction ID to view metrics.</div>}
//         </TabsContent>
